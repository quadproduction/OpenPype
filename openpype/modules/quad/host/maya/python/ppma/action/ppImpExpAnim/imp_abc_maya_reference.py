...
class Importer(object):
    ...
    def __init__(self, parent):
        ...
        self.name = "Abc Maya Reference Importer"
    ...
    def _find_node_relative_to_sg_pf(self, sg_published_file):
        ...
        for ref_node in self.p.references.keys():
            if self.p.references[ref_node].ctx:
                ...
                if rf.get("entity_type") == 'Shot' and os.path.splitext(rf.get("path"))[1] == ".abc":
    ...
    def imp(self, nodes=[]):
        ...
        # clean ppNode use for force the reference mapping.reference
        self._clean_force_remapping_reference()
